...
// const Skills = () => {
//   return (
//     <StyledSkills data-aos="zoom-in-up">
...
const Skills = () => {
  return (
    <div className="m-5 max-w-2xl mx-auto">
      <h3 className="text-center mb-8">Languages and Tools:</h3>
      <div className="grid grid-cols-2 gap-5 justify-center transition-transform duration-300">
        <Link
          href="https://babeljs.io/"
          target="_blank"
          rel="noreferrer"
          className="hover:scale-150 hover:text-secondary-main"
        >
          <Image
